-- Cotizaciones CRM — servicios y PDFs por producto
-- Ejecutar: php scripts/run-cotizaciones-migration.php

CREATE TABLE IF NOT EXISTS cotizaciones (
  id              INT UNSIGNED NOT NULL AUTO_INCREMENT,
  nombre          VARCHAR(160) NOT NULL,
  slug            VARCHAR(100) NOT NULL,
  categoria       ENUM('sitio','ecommerce','branding','automatizacion','soporte','general') NOT NULL DEFAULT 'sitio',
  resumen         VARCHAR(500) DEFAULT NULL,
  descripcion     TEXT DEFAULT NULL,
  incluye         TEXT DEFAULT NULL,
  precio_etiqueta VARCHAR(120) DEFAULT NULL,
  precio_minimo   VARCHAR(120) DEFAULT NULL,
  precio_nota     VARCHAR(255) DEFAULT NULL,
  comision_nota   VARCHAR(255) DEFAULT NULL,
  ...
  PRIMARY KEY (id),
  UNIQUE KEY uq_cotizaciones_slug (slug),
  KEY idx_cotizaciones_activo_orden (activo, orden)
